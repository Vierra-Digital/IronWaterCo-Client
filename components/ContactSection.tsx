    ...
    <section id="contact" className="contact-section" aria-labelledby="contact-heading">
      <div className="container">
        ...
        <div className="contact-grid">
          <div ref={mapRef} className="contact-map fade-in" aria-label="Iron & Water Co. Location Map">
            <iframe
              ...
              title="Iron & Water Co. Location - 1506 Northern Blvd, Manhasset, NY 11030"
              aria-label="Interactive map showing Iron & Water Co. location at 1506 Northern Blvd, Manhasset, NY"
            />
          </div>
              ...
              <div className="contact-details">
                <div className="contact-item" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                  ...
                  <div>
                    ...
                    <p itemProp="streetAddress">1506 Northern Blvd</p>
                    <p><span itemProp="addressLocality">Manhasset</span>, <span itemProp="addressRegion">NY</span> <span itemProp="postalCode">11030</span></p>
                  </div>
                </div>
                <div className="contact-item" itemProp="telephone">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                  ...
                  <div>
                    <strong>Phone</strong>
                    <p><a href="tel:329-233-6638" aria-label="Call Iron & Water Co. at 329-233-6638">329-233-6638</a></p>
                  </div>
                </div>
                <div className="contact-item" itemProp="email">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                  ...
                  <div>
                    <strong>Email</strong>
                    <p><a href="mailto:customerexperience@ironandwaterco.com" target="_blank" rel="noopener noreferrer" aria-label="Email Iron & Water Co. at customerexperience@ironandwaterco.com">customerexperience@ironandwaterco.com</a></p>
                  </div>
                </div>
